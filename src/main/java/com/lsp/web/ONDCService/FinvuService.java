...
public class FinvuService {
	...
	private static final String ALGORITHM = "AES/CBC/PKCS5Padding";
    private static final String UAT_PASSPHRASE = "fR8#zL1nQ7$vTp3K";
    ...
    public static String linkparam(String txnid,String srcref,String mobilenumber, String redirecturl){
        ...
        String redirectionlinkforaa = "https://webvwlive.finvu.in/onboarding?ecreq="+ecreq+"&reqdate="+salt+"&fi="+xorObfuscate+"&requestorType="+requesterType;
